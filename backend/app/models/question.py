...
class Question(Base):
    ...
    source_question_id: Mapped[str | None] = mapped_column(String(200), nullable=True, index=True)
    source_url: Mapped[str | None] = mapped_column(String(500), nullable=True)
    quality_status: Mapped[str] = mapped_column(String(50), nullable=False, default="ok", index=True)
    requires_image: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, index=True)
